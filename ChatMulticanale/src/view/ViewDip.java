...
//dip ha GRANT sulle operazioni: LD, LM, IM, RM1, RM2, LC1, LP, IC2
public class ViewDip {
    ...
    protected enum OPERATION{
        ...
        CREA_CANALE_PRIVATO, //IC2 utilizzata impropriamente nella risposta privata che crea un canale privato
        LOGOUT,
    ...
    public static void begin() {
        System.out.println("Sei nella view del dipendente!\n\n");
        OPERATION operation;
    ...
    private static void listaCanaliNelProgetto() {
        ...
        System.out.println("Questi sono i canali disponibili nel progetto: "+CorrenteRuoloInProgetto.getNomeProgetto()+" per il tuo utente: "+CorrenteRuoloInProgetto.getUsername()+"\t"+CorrenteRuoloInProgetto.getRuoloInProgetto()+"\n");
        ...
        do{
            do {
                if (CanaleCorrente.isPrivato()){operation = OPERATION.privateChannelDispatchMap(ScannerUtility.askFirstChar(PRIVATE_CHANNEL_DISPATCH));}
